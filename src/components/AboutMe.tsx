      ...
      <div className="relative bg-[#161b22]/95 backdrop-blur-xl border border-[#30363d] rounded-2xl max-w-2xl w-full shadow-2xl">
        ...
        <div className="p-8">
          ...
          <p className="text-gray-300 leading-relaxed mb-6">
            ...
            , currently pursuing an honors program in Artificial Intelligence
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="flex items-start gap-3 bg-[#1c2128] p-4 rounded-xl border border-[#30363d]">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Completed two frontend development internships, gaining
                  hands-on experience in building scalable, user-friendly web
                  applications.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 bg-[#1c2128] p-4 rounded-xl border border-[#30363d]">
              ...
              <div>
                <h3 className="text-white font-semibold">
                  Katalyst India Mentee
                </h3>
                <p className="text-gray-400 text-sm">
                  Undergoing structured technical and soft skills training,
                  preparing to contribute effectively in professional
                  environments.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 bg-[#1c2128] p-4 rounded-xl border border-[#30363d]">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Skilled in full-stack development (MERN) with growing
                  expertise in AI/ML. Adaptable and quick to learn new
                  technologies as projects demand.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3 bg-[#1c2128] p-4 rounded-xl border border-[#30363d]">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Experienced in art and graphic design, with freelance work as
                  an artist. I aim to integrate creativity with technology to
                  design solutions that are both functional and visually
                  engaging.
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  ...
                  <span className="text-amber-200">
                    hackathon teams to collaborate{" "}
                  </span>{" "}
                  on innovative projects. Currently{" "}
                  <span className="text-amber-200">
                    looking for internship opportunities{" "}
                  </span>
                  where I can apply my skills, learn from industry experts, and
